...
export default function LecturerMonitoring() {
  ...
  const loadData = async () => {
    ...
    setError(null);
    try {
      console.log("📊 Fetching reports for lecturer:", profile.id);
      ...
      console.log("📊 Reports count:", reportsData?.length || 0);
      console.log("⭐ Ratings received:", ratingsData);
              ...
              reports.map((report, index) => (
                <View key={report.id || index} style={s.reportCard}>
                  ...
                  >
                    ...
                    <Text style={s.meta}>📅 {report.dateOfLecture || "N/A"}</Text>
                    <Text style={s.meta}>
